/*
 ...
 Source Schema         : ax_blog

 Target Server Type    : MySQL
 Target Server Version : 50739
 File Encoding         : 65001

 Date: 16/04/2023 02:20:39
*/
...
-- ----------------------------
-- Table structure for ax_article
-- ----------------------------
DROP TABLE IF EXISTS `ax_article`;
CREATE TABLE `ax_article`  (
  ...
  `type` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '2' COMMENT '文章类型:1 文章 2 草稿',
...
-- ----------------------------
-- Records of ax_article
-- ----------------------------
INSERT INTO `ax_article` VALUES (1, 'SpringSecurity从入门到精通', '## 课程介绍\n![image20211219121555979.png](https://sg-blog-oss.oss-cn-beijing.aliyuncs.com/2022/01/31/e7131718e9e64faeaf3fe16404186eb4.png)\n\n## 0. 简介1\n\n​	**Spring Security** 是 Spring 家族中的一个安全管理框架。相比与另外一个安全框架**Shiro**，它提供了更丰富的功能，社区资源也比Shiro丰富。\n\n​	一般来说中大型的项目都是使用**SpringSecurity** 来做安全框架。小项目有Shiro的比较多，因为相比与SpringSecurity，Shiro的上手更加的简单。\n\n​	 一般Web应用的需要进行**认证**和**授权**。\n\n​		**认证：验证当前访问系统的是不是本系统的用户，并且要确认具体是哪个用户**\n\n​		**授权：经过认证后判断当前用户是否有权限进行某个操作**\n\n​	而认证和授权也是SpringSecurity作为安全框架的核心功能。\n\n\n\n## 1. 快速入门\n\n### 1.1 准备工作\n\n​	我们先要搭建一个简单的SpringBoot工程\n\n① 设置父工程 添加依赖\n\n~~~~\n    <parent>\n        <groupId>org.springframework.boot</groupId>\n        <artifactId>spring-boot-starter-parent</artifactId>\n        <version>2.5.0</version>\n    </parent>\n    <dependencies>\n        <dependency>\n            <groupId>org.springframework.boot</groupId>\n            <artifactId>spring-boot-starter-web</artifactId>\n        </dependency>\n        <dependency>\n            <groupId>org.projectlombok</groupId>\n            <artifactId>lombok</artifactId>\n            <optional>true</optional>\n        </dependency>\n    </dependencies>\n~~~~\n\n② 创建启动类\n\n~~~~\n@SpringBootApplication\npublic class SecurityApplication {\n\n    public static void main(String[] args) {\n        SpringApplication.run(SecurityApplication.class,args);\n    }\n}\n\n~~~~\n\n③ 创建Controller\n\n~~~~java\n\nimport org.springframework.web.bind.annotation.RequestMapping;\nimport org.springframework.web.bind.annotation.RestController;\n\n@RestController\npublic class HelloController {\n\n    @RequestMapping(\"/hello\")\n    public String hello(){\n        return \"hello\";\n    }\n}\n\n~~~~\n\n\n\n### 1.2 引入SpringSecurity\n\n​	在SpringBoot项目中使用SpringSecurity我们只需要引入依赖即可实现入门案例。\n\n~~~~xml\n        <dependency>\n            <groupId>org.springframework.boot</groupId>\n            <artifactId>spring-boot-starter-security</artifactId>\n        </dependency>\n~~~~\n\n​	引入依赖后我们在尝试去访问之前的接口就会自动跳转到一个SpringSecurity的默认登陆页面，默认用户名是user,密码会输出在控制台。\n\n​	必须登陆之后才能对接口进行访问。\n\n\n\n## 2. 认证\n\n### 2.1 登陆校验流程\n![image20211215094003288.png](https://sg-blog-oss.oss-cn-beijing.aliyuncs.com/2022/01/31/414a87eeed344828b5b00ffa80178958.png)', '2', 'SpringSecurity框架教程-Spring Security+JWT实现项目级前端分离认证授权', 1, 'https://sg-blog-oss.oss-cn-beijing.aliyuncs.com/2022/01/31/948597e164614902ab1662ba8452e106.png', '1', '0', 0, 108, '0', NULL, '2022-01-23 23:20:11', NULL, NULL, 0);
INSERT INTO `ax_article` VALUES (2, 'weq', 'adadaeqe', '2', 'adad', 2, 'https://sg-blog-oss.oss-cn-beijing.aliyuncs.com/2022/01/15/fd2e9460c58a4af3bbeae5d9ed581688.png', '1', '0', 0, 22, '0', NULL, '2022-01-21 14:58:30', NULL, NULL, 1);
INSERT INTO `ax_article` VALUES (3, 'dad', 'asdasda', '2', 'sadad', 1, 'https://sg-blog-oss.oss-cn-beijing.aliyuncs.com/2022/01/15/737a0ed0b8ea430d8700a12e76aa1cd1.png', '1', '0', 0, 33, '0', NULL, '2022-01-18 14:58:34', NULL, NULL, 1);
INSERT INTO `ax_article` VALUES (5, 'sdad', '![Snipaste_20220115_165812.png](https://sg-blog-oss.oss-cn-beijing.aliyuncs.com/2022/01/15/1d9d283f5d874b468078b183e4b98b71.png)\r\n\r\n## sda \r\n\r\n222\r\n### sdasd newnewnew', '2', '修改摘要', 2, '', '1', '0', 0, 44, '0', NULL, '2022-01-17 14:58:37', NULL, '2023-04-14 15:13:52', 0);
INSERT INTO `ax_article` VALUES (6, '添加博文测试', '这是测试', '2', '测试', 2, 'http://rsw3xbn3b.hn-bkt.clouddn.com/2023/04/12/7944ce4c168b4a3cb41571ce006ebf8e.png', '1', '0', 0, 0, '0', 1, '2023-04-12 19:32:11', 1, '2023-04-12 19:32:11', 0);

-- ----------------------------
-- Table structure for ax_article_tag
-- ----------------------------
DROP TABLE IF EXISTS `ax_article_tag`;
CREATE TABLE `ax_article_tag`  (
  `article_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '文章id',
  `tag_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '标签id',
  PRIMARY KEY (`article_id`, `tag_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '文章标签关联表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ax_article_tag
-- ----------------------------
INSERT INTO `ax_article_tag` VALUES (1, 4);
INSERT INTO `ax_article_tag` VALUES (2, 1);
INSERT INTO `ax_article_tag` VALUES (2, 4);
INSERT INTO `ax_article_tag` VALUES (3, 4);
INSERT INTO `ax_article_tag` VALUES (3, 5);
INSERT INTO `ax_article_tag` VALUES (6, 1);
INSERT INTO `ax_article_tag` VALUES (6, 6);

-- ----------------------------
-- Table structure for ax_category
-- ----------------------------
...
-- ----------------------------
-- Records of ax_category
-- ----------------------------
INSERT INTO `ax_category` VALUES (1, 'Java', -1, 'wsd', '0', NULL, NULL, NULL, NULL, 0);
INSERT INTO `ax_category` VALUES (2, 'Python', -1, 'wsd', '0', NULL, NULL, NULL, NULL, 0);

-- ----------------------------
-- Table structure for ax_comment
-- ----------------------------
...
CREATE TABLE `ax_comment`  (
  ...
  `del_flag` int(1) NULL DEFAULT 0 COMMENT '删除标志（0代表未删除，1代表已删除）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 39 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '评论表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ax_comment
-- ----------------------------
INSERT INTO `ax_comment` VALUES (1, '0', 1, -1, 'asS', -1, -1, 1, '2022-01-29 07:59:22', 1, '2022-01-29 07:59:22', 0);
INSERT INTO `ax_comment` VALUES (2, '0', 1, -1, '[哈哈]SDAS', -1, -1, 1, '2022-01-29 08:01:24', 1, '2022-01-29 08:01:24', 0);
INSERT INTO `ax_comment` VALUES (3, '0', 1, -1, '是大多数', -1, -1, 1, '2022-01-29 16:07:24', 1, '2022-01-29 16:07:24', 0);
INSERT INTO `ax_comment` VALUES (4, '0', 1, -1, '撒大声地', -1, -1, 1, '2022-01-29 16:12:09', 1, '2022-01-29 16:12:09', 0);
INSERT INTO `ax_comment` VALUES (5, '0', 1, -1, '你再说什么', -1, -1, 1, '2022-01-29 18:19:56', 1, '2022-01-29 18:19:56', 0);
INSERT INTO `ax_comment` VALUES (6, '0', 1, -1, 'hffd', -1, -1, 1, '2022-01-29 22:13:52', 1, '2022-01-29 22:13:52', 0);
INSERT INTO `ax_comment` VALUES (9, '0', 1, 2, '你说什么', 1, 2, 1, '2022-01-29 22:18:40', 1, '2022-01-29 22:18:40', 0);
INSERT INTO `ax_comment` VALUES (10, '0', 1, 2, '哈哈哈哈[哈哈]', 1, 9, 1, '2022-01-29 22:29:15', 1, '2022-01-29 22:29:15', 0);
INSERT INTO `ax_comment` VALUES (11, '0', 1, 2, 'we全文', 1, 10, 3, '2022-01-29 22:29:55', 1, '2022-01-29 22:29:55', 0);
INSERT INTO `ax_comment` VALUES (12, '0', 1, -1, '王企鹅', -1, -1, 1, '2022-01-29 22:30:20', 1, '2022-01-29 22:30:20', 0);
INSERT INTO `ax_comment` VALUES (13, '0', 1, -1, '什么阿是', -1, -1, 1, '2022-01-29 22:30:56', 1, '2022-01-29 22:30:56', 0);
INSERT INTO `ax_comment` VALUES (14, '0', 1, -1, '新平顶山', -1, -1, 1, '2022-01-29 22:32:51', 1, '2022-01-29 22:32:51', 0);
INSERT INTO `ax_comment` VALUES (15, '0', 1, -1, '2222', -1, -1, 1, '2022-01-29 22:34:38', 1, '2022-01-29 22:34:38', 0);
INSERT INTO `ax_comment` VALUES (16, '0', 1, 2, '3333', 1, 11, 1, '2022-01-29 22:34:47', 1, '2022-01-29 22:34:47', 0);
INSERT INTO `ax_comment` VALUES (17, '0', 1, 2, '回复weqedadsd', 3, 11, 1, '2022-01-29 22:38:00', 1, '2022-01-29 22:38:00', 0);
INSERT INTO `ax_comment` VALUES (18, '0', 1, -1, 'sdasd', -1, -1, 1, '2022-01-29 23:18:19', 1, '2022-01-29 23:18:19', 0);
INSERT INTO `ax_comment` VALUES (19, '0', 1, -1, '111', -1, -1, 1, '2022-01-29 23:22:23', 1, '2022-01-29 23:22:23', 0);
INSERT INTO `ax_comment` VALUES (20, '0', 1, 1, '你说啥？', 1, 1, 1, '2022-01-30 10:06:21', 1, '2022-01-30 10:06:21', 0);
INSERT INTO `ax_comment` VALUES (21, '0', 1, -1, '友链添加个呗', -1, -1, 1, '2022-01-30 10:06:50', 1, '2022-01-30 10:06:50', 0);
INSERT INTO `ax_comment` VALUES (22, '1', 1, -1, '友链评论2', -1, -1, 1, '2022-01-30 10:08:28', 1, '2022-01-30 10:08:28', 0);
INSERT INTO `ax_comment` VALUES (23, '1', 1, 22, '回复友链评论3', 1, 22, 1, '2022-01-30 10:08:50', 1, '2022-01-30 10:08:50', 0);
INSERT INTO `ax_comment` VALUES (24, '1', 1, -1, '友链评论4444', -1, -1, 1, '2022-01-30 10:09:03', 1, '2022-01-30 10:09:03', 0);
INSERT INTO `ax_comment` VALUES (25, '1', 1, 22, '收到的', 1, 22, 1, '2022-01-30 10:13:28', 1, '2022-01-30 10:13:28', 0);
INSERT INTO `ax_comment` VALUES (26, '0', 1, -1, 'sda', -1, -1, 1, '2022-01-30 10:39:05', 1, '2022-01-30 10:39:05', 0);
INSERT INTO `ax_comment` VALUES (27, '0', 1, 1, '说你咋地', 1, 20, 14787164048662, '2022-01-30 17:19:30', 14787164048662, '2022-01-30 17:19:30', 0);
INSERT INTO `ax_comment` VALUES (28, '0', 1, 1, 'sdad', 1, 1, 14787164048662, '2022-01-31 11:11:20', 14787164048662, '2022-01-31 11:11:20', 0);
INSERT INTO `ax_comment` VALUES (29, '0', 1, -1, '你说是的ad', -1, -1, 14787164048662, '2022-01-31 14:10:11', 14787164048662, '2022-01-31 14:10:11', 0);
INSERT INTO `ax_comment` VALUES (30, '0', 1, 1, '撒大声地', 1, 1, 14787164048662, '2022-01-31 20:19:18', 14787164048662, '2022-01-31 20:19:18', 0);
INSERT INTO `ax_comment` VALUES (31, '0', 1, -1, 'new', -1, -1, -1, '2023-04-10 14:02:36', -1, '2023-04-10 14:02:36', 0);
INSERT INTO `ax_comment` VALUES (32, '0', 1, -1, 'new', -1, -1, -1, '2023-04-10 14:04:57', -1, '2023-04-10 14:04:57', 0);
INSERT INTO `ax_comment` VALUES (33, '0', 1, -1, 'new', -1, -1, -1, '2023-04-10 14:05:22', -1, '2023-04-10 14:05:22', 0);
INSERT INTO `ax_comment` VALUES (34, '0', 1, -1, 'new', -1, -1, 1, '2023-04-10 14:10:10', 1, '2023-04-10 14:10:10', 0);
INSERT INTO `ax_comment` VALUES (35, '0', 1, -1, '发表评论测试', -1, -1, 1, '2023-04-10 14:38:39', 1, '2023-04-10 14:38:39', 0);
INSERT INTO `ax_comment` VALUES (36, '0', 1, 12, '企鹅王[嘻嘻][哈哈]', 1, 12, 1, '2023-04-10 14:43:27', 1, '2023-04-10 14:43:27', 0);
INSERT INTO `ax_comment` VALUES (37, '1', 1, -1, '发表友链评论测试', -1, -1, 1, '2023-04-10 15:19:33', 1, '2023-04-10 15:19:33', 0);
INSERT INTO `ax_comment` VALUES (38, '1', 1, 37, '子评论测试', 1, 37, 1, '2023-04-10 15:19:48', 1, '2023-04-10 15:19:48', 0);

-- ----------------------------
-- Table structure for ax_link
-- ----------------------------
DROP TABLE IF EXISTS `ax_link`;
CREATE TABLE `ax_link`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
-- Records of ax_tag
-- ----------------------------
INSERT INTO `ax_tag` VALUES (1, 'Mybatis', NULL, NULL, NULL, '2022-01-11 09:20:50', 0, 'weqwe');
INSERT INTO `ax_tag` VALUES (2, 'MybatisPlus', NULL, '2022-01-11 09:20:55', NULL, '2022-01-11 09:20:55', 1, 'weqw');
INSERT INTO `ax_tag` VALUES (3, 'WEB', NULL, '2022-01-11 09:21:07', NULL, '2022-01-11 09:21:07', 1, 'qweqwe');
INSERT INTO `ax_tag` VALUES (4, 'Java', NULL, '2022-01-13 15:22:43', NULL, '2023-04-12 14:46:17', 0, 'Java从入门到放弃');
INSERT INTO `ax_tag` VALUES (5, 'WAD', NULL, '2022-01-13 15:22:47', NULL, '2022-01-13 15:22:47', 1, 'ASDAD');
INSERT INTO `ax_tag` VALUES (6, 'C#', 1, '2023-04-12 14:15:36', 1, '2023-04-12 14:15:36', 0, 'Cshape');
...
INSERT INTO `sys_role` VALUES (13, '测试新增角色', 'wds', 3, '0', '0', NULL, NULL, NULL, NULL, '我是角色备注(修改了)');
...
INSERT INTO `sys_role_menu` VALUES (13, 2028);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'ax', 'axiang', '$2a$10$Jnq31rRkNV3RNzXe0REsEOSKaYK8UgVZZqlNlNXqn.JeVcj2NdeZy', '1', '0', '23412332@qq.com', '18888888888', '2', 'http://rsw3xbn3b.hn-bkt.clouddn.com/2023/04/10/5546e06bf63340a78decee87068c09af.jpg', NULL, '2022-01-05 09:01:56', 1, '2022-01-30 15:37:03', 0);
...
INSERT INTO `sys_user` VALUES (14787164048663, 'sheep', 'lazysheep', '$2a$10$lkh9w6HqU8KW3vAN3Ky13.dpjU0kY/mqynXdKaN9M04s2PipUIyjK', '0', '0', 'sheep@1.com', NULL, '1', 'http://rsw3xbn3b.hn-bkt.clouddn.com/2023/04/10/e0f8a15b5f9749d58530007986ea07bf.jpg', NULL, NULL, NULL, NULL, 0);
